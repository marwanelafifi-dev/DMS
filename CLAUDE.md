...
- Backend: manual code review only — brace/paren counts balanced (158/158, 512/512 in the final state) across the whole file; no local `dotnet build` available on this workstation.
