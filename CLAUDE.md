...
### Files modified
`api/Controllers/DocumentsController.cs`, `web/index.html`, `web/src/App.tsx`, `web/src/components/pages/{Documents,Search}.tsx`, `web/src/components/custom/{DocumentPreview,DocumentList,LibraryMenus,PdfJsViewer,UserManagement,FolderTree}.tsx`, `web/src/components/layout/MainLayout.tsx`, `web/src/hooks/useAllDmsDocuments.ts`
