...
- Backend: manual code review only — brace/paren counts balanced (157/157, 507/507 in the final state) across the whole file; no local `dotnet build` available on this workstation.
